...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="fas fa-coins me-2"></i>Add Expense</h1>
        ...
        <form method="POST" action="{{ route('expenses.store') }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="category" value="{{ old('category') }}" placeholder="e.g., Transport, Labour, Utilities" required>
